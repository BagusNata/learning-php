...
<html lang="en">
  ...
  <body>
    ...
    <div class="container"> 
      ...
      <h1 class="title">Delete Data Dosen</h1>
      </br> 
          ...
          <tbody class="table-body">
            <tr>
              ...
              <td class="text-center"> 
                <a style="color:black;" href="proses_delete_dosen.php?nidn=<?php echo $data['nidn']?>" class="btn-del"> <img src="Assets/Image/b_drop.png"> Delete </a>
              </td>
            </tr>
            <?php } ?>
          </tbody>
